<template>
  <div>
    ...
    <el-table width="100%" border :data="customerinfo" stripe height="400px">
      ...
      <el-table-column label="购买人" prop="customerinfos.customername" align="center"></el-table-column>
      <el-table-column label="相关文档" prop="documentations.filename" align="center"></el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      "find": function (currentPage, size) {
        this.$http.get("houRecharge/houFindDocuemnt", {
          params: {
